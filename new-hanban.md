...
PARTI COMMUNISTE CHINOIS (PCC) 
         ...
         └── Département du Travail du Front Uni (统战部)
                |
        ┌───────┴────────┐
        |                |
      CLEC             CIEF
  (Ex-Hanban)    (中国国际中文教育基金会)
                 [Président: Yang Wei]
                        |
        ┌───────────────┼───────────────┐
        |               |               |
  Univ. Xiamen    Univ. Ludong    Univ. Nanchang
  [Cadres PCC]    [Cadres PCC]    [Cadres PCC]
        |               |               |
   IC Côte d'Azur  IC Bretagne   IC Poitiers
